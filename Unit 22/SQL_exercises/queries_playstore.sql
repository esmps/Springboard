...
SELECT category, COUNT(*) AS num_games_in_category FROM analytics GROUP BY category;
...
SELECT SUM(reviews) AS "Sum of All Reviews" FROM analytics;
-- Find all the categories that have more than 300 apps in them.
SELECT category, COUNT(app_name) AS "num_of_apps" FROM analytics GROUP BY category HAVING COUNT(app_name) > 300;
